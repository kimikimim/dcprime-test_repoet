...
--
-- ⚠️ 시험 스키마를 관리자가 직접 만드는 방식으로 재설계했습니다.
--    재실행하면 기존 rc_exams/rc_scores 데이터가 전부 삭제되고 새로 만들어집니다.
-- ============================================================
...
DROP TABLE IF EXISTS rc_scores;
DROP TABLE IF EXISTS rc_exams;
...
CREATE INDEX idx_rc_scores_exam_grade ON rc_scores (exam_id, grade);
