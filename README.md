...
시험 성적을 구글 스프레드시트로 입력받아 Supabase에 동기화하고, 학생별 성적표를 JPG로 다운로드하는 내부 도구.
...
화면 "시험 관리" 탭에서 구글 스프레드시트 ID를 입력하고 저장하면 됩니다. 시트는 "링크가 있는 모든 사용자 - 뷰어"로 공유되어 있어야 하고, 첫 번째 시트 탭의 컬럼 순서는 다음과 같아야 합니다 (헤더 행 1줄 포함):
